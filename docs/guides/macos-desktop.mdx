...
AgentUse checks quietly for updates without interrupting startup. Open
**Settings → About** to check manually. When an update is available, choose
**Download Update**, then **Restart and Install**; AgentUse never installs an
