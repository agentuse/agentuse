...
```bash
bun scripts/release.ts prepare 0.19.1
```
...
check for the update, download it, choose **Restart and Install**, and confirm
the new version launches. Also repeat a check while offline and confirm the app
continues working while the About tab reports the failure.
