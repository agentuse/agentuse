...
Because nobody is watching the run, the rehearsal has to happen beforehand: [`agentuse test`](/guides/testing-agents) exercises the whole SOP, including approval branches, with side effects fabricated.
