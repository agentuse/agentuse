...
As a safety net, AgentUse caps `bash` output (head + tail, 30KB default) and `read_file` output (2000 lines default). Tune these with the [Tool Output environment variables](/reference/environment-variables#tool-output):
