...
<Tip>
  Use cheaper models like `openrouter:minimax/minimax-m2.1` for frequent, straightforward tasks (health checks, simple monitoring). Reserve `claude-sonnet-4-6` and `claude-opus-4-6` for complex creative tasks.
</Tip>
