...
<ParamField path="model" type="string" required>
  ...
  **Named aliases.** `@name` resolves through the `models.aliases` block of your
  ...
  limited to transient failures before a fresh session receives any model output
  or tool call; resumes remain pinned to the concrete model already recorded.
