...
|----------|------|---------|--------|--------------|
| `anthropic:claude-opus-4-7` | Claude Opus 4.7 | 1,000,000 | 128,000 | Reasoning, Vision, Tools |
...
| Model ID | Name | Context | Output | Capabilities |
|----------|------|---------|--------|--------------|
| `openai:gpt-5.5` | GPT-5.5 | 1,050,000 | 128,000 | Reasoning, Vision, Tools |
| `openai:gpt-5.5-pro` | GPT-5.5 Pro | 1,050,000 | 128,000 | Reasoning, Vision, Tools |
...
| `openai:gpt-5.4-mini` | GPT-5.4 mini | 400,000 | 128,000 | Reasoning, Vision, Tools |
| `openai:gpt-5.4-nano` | GPT-5.4 nano | 400,000 | 128,000 | Reasoning, Vision, Tools |
