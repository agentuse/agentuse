...
| `openrouter:z-ai/glm` | `openrouter:z-ai/glm-5.2` |
| `openrouter:z-ai/glm-turbo` | `openrouter:z-ai/glm-5v-turbo` |
| `openrouter:x-ai/grok` | `openrouter:x-ai/grok-4.5` |
...
| `openrouter:qwen/qwen-max` | `openrouter:qwen/qwen3.7-max` |
| `openrouter:google/gemini-flash` | `openrouter:google/gemini-3.6-flash` |
...
| Model ID | Name | Input Context | Output | Capabilities |
|----------|------|---------|--------|--------------|
| `openrouter:z-ai/glm-5.2` | GLM-5.2 | 1,048,576 | 128,000 | Reasoning, Tools |
| `openrouter:z-ai/glm-5v-turbo` | GLM-5V-Turbo | 202,752 | 131,072 | Reasoning, Vision, Tools |
| `openrouter:x-ai/grok-4.5` | Grok 4.5 | 500,000 | 500,000 | Reasoning, Vision, Tools |
| `openrouter:deepseek/deepseek-v4-pro` | DeepSeek V4 Pro | 1,048,576 | 384,000 | Reasoning, Tools |
| `openrouter:deepseek/deepseek-v4-flash` | DeepSeek V4 Flash | 1,048,576 | 393,216 | Reasoning, Tools |
...
| `openrouter:google/gemini-3.6-flash` | Gemini 3.6 Flash | 1,048,576 | 65,536 | Reasoning, Vision, Tools |
...
| `openrouter:moonshotai/kimi-k3` | Kimi K3 | 1,048,576 | 1,048,576 | Reasoning, Vision, Tools |
