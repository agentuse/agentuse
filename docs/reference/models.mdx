...
| Model ID | Name | Input Context | Output | Capabilities |
|----------|------|---------|--------|--------------|
| `openrouter:z-ai/glm-5.2` | GLM-5.2 | 1,048,576 | 131,072 | Reasoning, Tools |
...
| `openrouter:deepseek/deepseek-v4-flash` | DeepSeek V4 Flash | 1,048,576 | 65,536 | Reasoning, Tools |
