...
| `tidy` | Merge near-duplicates, sharpen corrections you have repeated, retire what is superseded, and make proven corrections permanent in the agent file. Applies immediately, then shows both diffs. |
