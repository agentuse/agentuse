...
# Set the public callback URL used in approval resume links
agentuse serve --public-url https://agentuse.mycompany.com

# Start with Slack approval enabled via Socket Mode
SLACK_BOT_TOKEN=xoxb-... SLACK_APP_TOKEN=xapp-... SLACK_APPROVAL_CHANNEL=C0123456789 agentuse serve
