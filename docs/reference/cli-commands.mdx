...
| `tidy` | Merge near-duplicates, sharpen corrections you have repeated, retire what is superseded, and make proven corrections permanent in the agent file. Applies immediately, then shows both diffs. Prints which batch it is planning as it goes: a pass over a large file takes a few minutes. |
